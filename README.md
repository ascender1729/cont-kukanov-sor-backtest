...
### BibTeX
```bibtex
@software{dubasi2024_contkukanov,
  author       = {Dubasi, Pavan Kumar},
  title        = {Cont \& Kukanov SOR Backtest: Smart Order Router Implementation},
  year         = {2024},
  publisher    = {GitHub},
  url          = {https://github.com/ascender1729/cont-kukanov-sor-backtest}
}
```

### APA Format
Dubasi, P. K. (2024). *Cont & Kukanov SOR Backtest: Smart Order Router Implementation*. GitHub. https://github.com/ascender1729/cont-kukanov-sor-backtest

### IEEE Format
P. K. Dubasi, "Cont & Kukanov SOR Backtest: Smart Order Router Implementation," GitHub, 2024. [Online]. Available: https://github.com/ascender1729/cont-kukanov-sor-backtest
